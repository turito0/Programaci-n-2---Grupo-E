...
def enmascarar_fecha(texto):
    ...
    if len (entryFecha.get())==10:
        fecha_actual=datetime.now().date()
        fecha_nacimiento=datetime.strptime(entryFecha.get(),"%d-%m-%Y").date()
...
entryFecha=ttk.Entry(frame_pacientes,validate="key",validatecommand=(validacion_fecha,"%P"))
